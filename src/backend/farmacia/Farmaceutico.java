...
public class Farmaceutico extends Funcionario implements Serializable {
	...
	public String toString() {
		return "Farmaceiutico [registroAnvisa=" + registroAnvisa + ", getRegistroAnvisa()=" + getRegistroAnvisa()
				...
				+ getPasep() + ",  Nome: " + getNome() + ", CPF: " + getCpf() + ", getRg()=" + getRg()
				+ ", getIdade()=" + getIdade() + ", getDataNascimento()=" + getDataNascimento() + ", getAltura()="
				+ getAltura() + ", getPeso()=" + getPeso() + ", toString()=" + super.toString() + ", toCSV()=" + toCSV()
