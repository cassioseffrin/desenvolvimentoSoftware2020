...
public class PrincipalColecoes {
	public static void main(String a[]) throws ClassNotFoundException {
		Pessoa p = new Pessoa();
		System.out.println( p.lerArquivoSerial());
...
//		Pessoa pessoa1 = new Pessoa("Cassio", "0234234234", "41333443", 18);
//		Pessoa pessoa2 = new Pessoa("Maria", "0234234234", "41333443", 32);
...
//		pessoa1.gravarArquivoSerial();
//		pessoa2.gravarArquivo();
 
//		ArrayList<Pessoa> colecao = pessoa1.lerTodos();
//		
//		Collections.sort(colecao);
//		pessoa1.imprimirColecaoPessoas(colecao);
